...
from .models import PatientQueue, PatientQueueHistory
from django.contrib import admin
...
class PatientQueueHistoryAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'id_number', 'phone', 'spot_number','estimated_time','closing_time','status')
    list_filter = ('status',)
    search_fields = ('first_name', 'last_name', 'id_number', 'phone')

admin.site.register(PatientQueueHistory, PatientQueueHistoryAdmin)
